...
import { AllocationPieChart } from "@/components/reporting/allocation-pie-chart";
import { AllocationHistoryChart } from "@/components/reporting/allocation-history-chart";
import {
  Card,
  CardContent,
  CardHeader,
...
export default function ReportingPage() {
  const { rules, transactions, loadingData } = useApp();
